  ...
  services: [
    {
      ...
      action: "./pages/services/services.html#washing-machine",
    },
    {
      ...
      action: "./pages/services/services.html#air-conditioner",
    },
    {
      ...
      action: "./pages/services/services.html#refrigerator",
    },
    {
      ...
      action: "./pages/services/services.html#water-purifier",
    },
    {
      ...
      action: "./pages/services/services.html#inverter-battery",
    },
  ],
  sales: [
    {
      ...
      productLonDesc:
        "Transform your water source into a haven of purity with our state-of-the-art RO systems. Crafted with precision and advanced technology, our systems are designed to remove impurities and contaminants, ensuring your family has access to the highest quality drinking water. Make the choice for health and well-being – choose our reliable and efficient water purification solutions that go beyond clean water; they provide peace of mind.",
      navigatorId: "water-purifier",
      action: "./pages/sales/sales.html#water-purifier",
    },
    {
      ...
      navigatorId: "inverter-battery",
      action: "./pages/sales/sales.html#inverter-battery",
    },
  ],
};
